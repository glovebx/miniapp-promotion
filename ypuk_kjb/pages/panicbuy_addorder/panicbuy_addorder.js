...
Page({
  ...
  onLoad: function (query) {
    ...
    GetActivityInfo: function() {
        let that = this;
        // t.util.request({
        //     url: "entry/wxapp/getpanicbuydetail",
        //     data: {
        //         uid: e.data.userId,
        ...
        //     cachetime: "0",
        //     success: function(t) {
        //         t.data.data.totalprice = Number(t.data.data.nowprice) + Number(t.data.data.freight), 
        //         e.setData({
      ...
      wx.request({
        ...
        success: function (res) {
          res.data.data.totalPrice = Number(res.data.data.panicPrice) + Number(res.data.data.freight);
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if (res.data.code == 10002) {
            ...
            // });
            // wx.redirectTo({
            //   url: "../../pages/panicbuy_orderdetail/panicbuy_orderdetail?orderno=" + res.data.data.orderNo
            // });
            if (res.data.data.calculate) {
              ...
              //   , "../../pages/panicbuy_orderdetail/panicbuy_orderdetail?orderno=" + res.data.data.orderNo);
  ...
  reLaunchMy: function () {
    // 回到到个人主页
    wx.reLaunch({
      url: "../../pages/panicbuy_orderdetail/panicbuy_orderdetail?orderno=" + this.data.orderNo
    });
  },
});