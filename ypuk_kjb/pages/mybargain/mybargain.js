...
Page({
  ...
  goLoginPageTimeOut: function () {
    ...
    //         e = wx.getStorageSync("userInfo"), a.setData({
    ...
    GetList: function() {
      ...
      let that = this;
      wx.request({
        url: app.config.URI + "/shop/promotion/my/list",
        header: {
          "Content-Type": "json"
        },
        data: {
        ...
        success: function (res) {
          res.data.data && 0 < res.data.data.length ? that.setData({
            bargainList: that.data.bargainList.concat(res.data.data)
          }) : that.setData({
            noMoreHidden: false
          });
        }
        ...
        //             bargainList: t.data.bargainList.concat(e.data.data)
        //         }) : t.setData({
        //             noMoreHidden: !1
        //         });
        //     }
