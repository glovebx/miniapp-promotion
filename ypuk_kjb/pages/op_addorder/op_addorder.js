...
Page({
  ...
  GetLastAddress: function () {
    ...
    GetActivityInfo: function() {
        ...
        //     cachetime: "0",
        //     success: function(t) {
        //         "" != t.data.data.opbuy_price && "0.00" != t.data.data.opbuy_price ? t.data.data.totalprice = Number(t.data.data.opbuy_price) + Number(t.data.data.freight) : t.data.data.totalprice = Number(t.data.data.oldprice) + Number(t.data.data.freight), 
        //         e.setData({
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          res.data.data.totalPrice = Number(res.data.data.buyPrice) + Number(res.data.data.freight);
          that.setData({
  ...
  onAnonymous: function (event) {
    ...
    addOrderBtn: function(event) {
      ...
      wx.request({
        ...
        // return "" == o.uname || "" == o.tel || "" == o.goodmodel ? (wx.showModal({
        //     title: "提示",
        //     content: "所有项均为必填项，请检查填写完整信息",
        //     showCancel: !1
        // }), e = 0, !1) : 0 == d.data.activityInfo.type && "" == o.address ? (wx.showModal({
        //     title: "提示",
        //     content: "所有项均为必填项，请检查填写完整信息",
        //     showCancel: !1
        // }), e = 0, !1) : void t.util.request({
        //     url: "entry/wxapp/addoporder",
        //     cachetime: "0",
        //     method: "POST",
        //     data: o,
        //     success: function(t) {
        ...
        //             title: "提交订单成功"
        //         }), wx.redirectTo({
        //             url: "../../pages/orderdetail/orderdetail?orderno=" + t.data.data
        //         }));
        //     },
        //     fail: function(t) {
        //         e = 0, wx.showModal({
