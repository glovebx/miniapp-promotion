...
function r(e, a, i, r) {
    ...
    if (d && 0 != d.images.length) {
        ...
        i.setData((t(o = {}, c, l.imageWidth), t(o, x, l.imageheight), o));
    }
}

function n(e, t, a, i) {
    var r, n = 0, o = 0, d = {}, l = a.data[i].view.imagePadding;
    return (r = s - 2 * l) < e ? (o = (n = r) * t / e, d.imageWidth = n, d.imageheight = o) : (d.imageWidth = e, 
    d.imageheight = t), d;
}
...
wx.getSystemInfo({
    ...
    wxParse: function() {
        ...
        g.view = {}, void (g.view.imagePadding = 0) !== s && (g.view.imagePadding = s);
        var m = {};
